...
export function ErrorCard(props: { message?: string; onRetry?: () => void; class?: string; children?: JSX.Element }) {
  return (
    <div
    ...
    >
      {props.children ?? (
        <p class="text-red-600 dark:text-red-400 font-semibold mb-4">{props.message}</p>
      )}
